---
title: "Writing LaTeX Code in Dynamic Documents using R"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Writing LaTeX Code in Dynamic Documents using R}
...
`` `r t(Vect(rv1, rv2))*Vect(rv1, rv2)` `` inside math environments.
